package com.sbs.exam.demo.shorts.repository;
...
@Mapper
	public interface ShortsRepository {
		...
		@Select("""
				...
				""")
		public Shorts getForPrintArticle(@Param("id") int id);
		...
		@Select("""
				...
				""")
		public List<Shorts> getForPrintArticles(int boardId, String searchKeywordTypeCode, String searchKeyword,
